...
KAFKA_BOOTSTRAP_SERVERS = "kafka-azure.servicebus.windows.net:9093"
KAFKA_TOPIC = "weatherapistream"
SASL_USERNAME = "$ConnectionString"
SASL_PASSWORD = "Endpoint=sb://kafka-azure.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=+EglVf4223K/6jUpB3OPZCcHywzoMuekr+AEhIipOc8="
API_TOKEN='b56e73c8d93a4136785e5620a8a3afcf585695d7'
# Cities
indian_cities = [
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    if data.get("status") == "ok":
                        ...
                        print(f"⚠️ Skipped (no data): {city}")
                else:
